    ...
    <main id="main-content">
        ...
        <section>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['user_id'])) {
                ...
                if ($password) {
                    $sql = "UPDATE users SET nama_user='$nama', usia='$usia', password='$password' WHERE id_user='$user_id'";
                } else {
                    $sql = "UPDATE users SET nama_user='$nama', usia='$usia' WHERE id_user='$user_id'";
                }
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && empty($_POST['user_id'])) {
                ...
                $sql = "INSERT INTO users (nama_user, usia, password) VALUES ('$nama', '$usia', '$password')";
        ...
        <section>
            ...
            <div class="description">
                ...
                <p>Angklung adalah alat musik tradisional dari Indonesia yang terbuat dari bambu.</p>
            </div>
            <div class="description">
                <img src="gamelan.jpg" alt="Gamelan">
                <p>Gamelan adalah ansambel musik tradisional Indonesia yang terdiri dari berbagai instrumen.</p>
            </div>
            <div class="description">
                <img src="saluang.jpg" alt="Saluang">
                <p>Saluang adalah alat musik tiup tradisional Minangkabau, terbuat dari bambu.</p>
            </div>
        </section>
    </main>

    <footer>
        <p>&copy; 2024 Pengenalan Alat Musik Tradisional. All rights reserved.</p>
    </footer>
